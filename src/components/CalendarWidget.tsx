...
import { formatDateReadable, parseDateLabel } from '../utils/dateUtils'
...
export function CalendarWidget({
  ...
  const fullDate = parseDateLabel(dueDate)
  if (!fullDate) {
  ...
  return (
    ...
    >
      <span
        className={className ?? 'cursor-help border-b border-dashed border-ink-300 text-ink-400 hover:text-ink-600'}
      >
        {dueDate}
      </span>
